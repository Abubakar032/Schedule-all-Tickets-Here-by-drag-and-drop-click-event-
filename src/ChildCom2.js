...
const Box2 = ({value}) => {
    ...
    const {handle_box2_d2, handeled_item_box3}=DataProvider();
    
    const length= data.length + handle_box2_d2.length;
  return (
...

    {
        data.map((currentItem, index)=>{
            ...
            <p><span className='font-bold'>visitFee</span>: {currentItem.visitFee}</p><div className='flex justify-between'>
